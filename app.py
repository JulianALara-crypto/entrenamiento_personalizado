                    ...
                    try:
                        respuesta_registro = requests.post(
                            ...
                            json={
                                ...
                                "condiciones_medicas": reg_condiciones if reg_condiciones else "NINGUNA",
                                "rol": "Cliente",
                                "password": reg_pass,
                                        ...
                                        try:
                                            ...
                                            respuesta_pago = requests.post(
                                                ...
                                                json={
                                                    "action": "guardar_pago",
                                                    "id_pago": str(id_pago),
                                                    "cedula": str(id_cliente),
                                                    "fecha_pago": str(fecha_pago),
                                                    "valor": float(valor_pago),
                                                    "concepto": str(concepto_pago),
                                                    "valor_mensualidad": float(valor_mensualidad),
                                                },
                                                timeout=30,
                                            )
                        ...
                        if guardar_config_plan:
                            try:
                                ...
                                respuesta_config = requests.post(
                                    ...
                                    json={
                                        "action": "guardar_plan",
                                        "cedula": str(id_cliente_clases),
                                        "nombre_completo": str(nombre_cliente_clases),
                                        "tipo_plan": str(plan_cliente),
                            ...
                            try:
                                ...
                                respuesta_clase = requests.post(
                                    ...
                                    json={
                                        ...
                                        "tipo_plan": str(resumen_actual["plan"]),
